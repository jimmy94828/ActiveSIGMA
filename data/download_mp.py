...
# Python 2/3 compatibility for `raw_input` and urllib functions used below.
try:
    raw_input  # Python 2: raw_input exists
except NameError:
    raw_input = input  # Python 3: alias raw_input to input
