...
map_every = 1
keyframe_every = 5
mapping_window_size = 32  # 32 frames are used to optimize the map during each mapping step. Should be >= keyframe_every
tracking_iters = 10
mapping_iters = 15
...
config = dict(
    ...
    mapping=dict(
        ...
        pruning_dict=dict( # Needs to be updated based on the number of mapping iterations
            ...
            removal_entropy_threshold = 0.01,
        ),
